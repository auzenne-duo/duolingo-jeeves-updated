...
JIRA_FEATURES = {
    "Monetization": {
        "no_area_monetization": {
            ...
            "Conversion": {
                "Super/Max - Purchase Flow": ["purchase page", "purchase screen", "purchase step"],
                "Super": [],
                "New Years Promo": [],
                "Student Plan": [],
                "Energy Retier": [],
            ...
            "Crossgrades": {
                "Super/Max - Crossgrades": ["upgrades", "downgrades"],
                "Family Plan": [],
                "Max": ["max user", "max", "max onboarding"],
                "Max Hooks": ["max purchase flow", "max crossgrade", "crossgrade"],
            },
            "Max": {
...
JIRA_TEAM_TO_PROJECT = {
    "Video Call Experience": ["VCCF", "VCE"],
...
JIRA_FEATURES_DESCRIPTIONS = {
    ...
    "Ads": "Problems with ads layout, audio, completion, etc.",
    ...
    "Immersive Super/Max": "Any temporary subscription won from opening a chest on the path, does not include free trials",
    ...
    "Max": "Anything with the Max subscriber experience. For purchasing Max via Video Call hooks, use 'Max Hooks'",
    "Max Hooks": "Anything related to 'Get Max' from Video Call upsells, Max purchase flow, and upgrading to Max from Super or Free, or upgrading from Max individual to Max Family Plan",
    ...
    "Super/Max - Purchasing": "Anything related to the actual act of purchasing, like wrong prices, refund problems, or purchasing failing",
