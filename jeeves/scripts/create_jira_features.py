...
if __name__ == "__main__":
    ...
    features_on_jira = ShakiraJiraClient.get_features(_PROJECTS)
    features_to_add = [
        required_feature
    ...
    issuetypes = ShakiraJiraClient.get_issuetype_metadata(_PROJECTS)
    feature_field_keys = {
    ...
    for field_key in feature_field_keys:
        context_ids = ShakiraJiraClient.get_contexts(field_key)

        for context_id in context_ids:
            ShakiraJiraClient.create_options_for_field(field_key, context_id, features_to_add)
