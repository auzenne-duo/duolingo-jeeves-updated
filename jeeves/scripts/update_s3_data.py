...
def downloadS3Tickets():
    ...
    for remoteFilePath in tqdm(list(S3.yield_filenames(S3_BUCKET_ID, S3_ZENDESK_DIR)), desc='Download Zendesk Tix'):
...
def downloadNewTicketsAndUploadToS3():
    ...
    for fName in tqdm(newFiles, desc='Upload Zendesk Tix'):
