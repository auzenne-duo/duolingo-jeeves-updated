...
class Test(unittest.TestCase):
    ...
    def test_extract_common_zendesk_headers(self) -> None:
        empty_test_input = ""
        empty_test_expected: Tuple[str, Dict[str, str]] = "", {}
        ...
        useless_test_expected: Tuple[str, Dict[str, str]] = useless_test_input, {}
        ...
        real_test_input = """\
Please discontinue the “Practice Complete” feature with the points calculator as it is a waste of learning time with \
no real benefit at all. It is very frustrating to have to sit and watch that feature so many times over and over \
during lessons. Waiting for it to finish is truly a waste of time that could be better spent learning. It is also \
...
I would like a refund please. I have just had a baby and I am working full time and unfortunately unable to use this \
subscription at this point in time. Please help!
